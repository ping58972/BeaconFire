...
//    @Before("com.beaconfire.pp_webservice_restful.AOP.PointCuts.inControllerLayer()")
//    public void logStartTime(){
//        logger.info("From LoggingAspect.logStartTime in controller: " + System.currentTimeMillis());
//    }
//    @After("com.beaconfire.pp_webservice_restful.AOP.PointCuts.inService()")
...
//    }
//
//    @AfterReturning(value = "com.beaconfire.pp_webservice_restful.AOP.PointCuts.inDAOLayer()", returning = "res")
...
//    }
//    @AfterThrowing(value = "com.beaconfire.pp_webservice_restful.AOP.PointCuts.inControllerLayer()", throwing = "ex")
...
//    @Around("com.beaconfire.pp_webservice_restful.AOP.PointCuts.inDAOLayer()")
...
//    @Around("com.beaconfire.pp_webservice_restful.AOP.PointCuts.inControllerLayer()")
